        ...
        <Dialog open={isOpen} onOpenChange={isClose} >
            <DialogContent className="sm:max-w-md bg-gray-900 text-white">
                ...
                <DialogDescription className="mt-2 text-white">
                    Tracking prices and managing your products is just a sign-in away. Please log in to continue enjoying our services.
                </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex flex-col gap-4 py-4">
                    <Button
                        ...
                        variant="outline"
                        className="w-full gap-2 bg-gray-900 text-white hover:bg-gray-800 hover:text-white"
                        size="lg"
                    >
